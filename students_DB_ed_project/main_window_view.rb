...
class MainWindowView < FXMainWindow
  ...
  def add_row_hardcode
    ...
    table.setItemText(0, 0, "Якухнов Р.А.")
    table.setItemText(0, 1, "@RedMaG02")
    table.setItemText(0, 2, "govnosoft_ceo@example.com")
    table.setItemText(1, 0, "Нагалевский А.М.")
    table.setItemText(1, 1, "@jakepps")
    table.setItemText(1, 2, "nullexp_director@example.com")
    table.setItemText(2, 0, "Гиренко Д.Е.")
    table.setItemText(2, 1, "@rab_yandexa")
    table.setItemText(2, 2, "rab_yandexa@yandex.ru")
    table.setItemText(3, 0, "Анищенко Е.С.")
    table.setItemText(3, 1, "@kate4ka")
    table.setItemText(3, 2, "kate4ka@egmail.com")
    table.setItemText(4, 0, "Якухнов Р.А.")
    table.setItemText(4, 1, "@RedMaG02")
    table.setItemText(4, 2, "govnosoft_ceo@example.com")
    table.setItemText(5, 0, "Нагалевский А.М.")
    table.setItemText(5, 1, "@jakepps")
    table.setItemText(5, 2, "nullexp_director@example.com")
    table.setItemText(6, 0, "Гиренко Д.Е.")
    table.setItemText(6, 1, "@rab_yandexa")
    table.setItemText(6, 2, "rab_yandexa@yandex.ru")
    table.setItemText(7, 0, "Анищенко Е.С.")
    table.setItemText(7, 1, "@kate4ka")
    table.setItemText(7, 2, "kate4ka@egmail.com")
    table.setItemText(8, 0, "Якухнов Р.А.")
    table.setItemText(8, 1, "@RedMaG02")
    table.setItemText(8, 2, "govnosoft_ceo@example.com")
    table.setItemText(9, 0, "Нагалевский А.М.")
    table.setItemText(9, 1, "@jakepps")
    table.setItemText(9, 2, "nullexp_director@example.com")
    table.setItemText(10, 0, "Гиренко Д.Е.")
    table.setItemText(10, 1, "@rab_yandexa")
    table.setItemText(10, 2, "rab_yandexa@yandex.ru")
    table.setItemText(11, 0, "Анищенко Е.С.")
    table.setItemText(11, 1, "@kate4ka")
    table.setItemText(11, 2, "kate4ka@egmail.com")
    table.setItemText(12, 0, "Якухнов Р.А.")
    table.setItemText(12, 1, "@RedMaG02")
    table.setItemText(12, 2, "govnosoft_ceo@example.com")
    table.setItemText(13, 0, "Нагалевский А.М.")
    table.setItemText(13, 1, "@jakepps")
    table.setItemText(13, 2, "nullexp_director@example.com")
    table.setItemText(14, 0, "Гиренко Д.Е.")
    table.setItemText(14, 1, "@rab_yandexa")
    table.setItemText(14, 2, "rab_yandexa@yandex.ru")
    table.setItemText(15, 0, "Анищенко Е.С.")
    table.setItemText(15, 1, "@kate4ka")
    table.setItemText(15, 2, "kate4ka@egmail.com")
